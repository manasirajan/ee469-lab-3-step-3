...
//
//	LAB3:
//  infinite loop for idle process
//
//----------------------------------------------------------------------
void ProcessIdle() {
  while(1);
...
void ProcessFreeResources (PCB *pcb) {
  ...
  //-----------------------------------------------------
  MboxCloseAllByPid((int)(pcb-pcbs));
...
//
//  LAB 3:
//  Currently the ProcessSchedule() function is a Round-Robin Scheduler.
//  You should keep the Round-Robin style code and use Macros mentioned
//  in the lab manual to add your Lottery Scheduler and make ProcessSchedule()
//  support both scheduler style.
//
//----------------------------------------------------------------------
...
//
//  LAB 3:
//  You need to add code to assign pnice and pinfo parameters to
//  pcb here in ProcessFork()
//
//----------------------------------------------------------------------
...
//
//  LAB3:
//  The ProcessIdle need to be started in the main function or inside
//  the ProcessModuleInit()
//
//----------------------------------------------------------------------
